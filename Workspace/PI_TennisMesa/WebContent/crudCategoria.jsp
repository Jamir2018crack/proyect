...
<body>
 ...
 <h1>Crud de Categoria</h1>
		 <div class="col-md-23" >  
			  <form id="idFormElimina" action="eliminaCategoria">
			  		<input type="hidden" id="id_elimina" name="id">
			  </form>	
				
		       <form accept-charset="UTF-8"  action="consultaCategoria" class="simple_form" id="defaultForm2"  method="post">
					<div class="row">
						<div class="col-md-3">	
					...
					<div class="row">
						...
						<div class="col-md-3">
							<button type="button" data-toggle='modal' onclick="registrarCategoria();"  class='btn btn-success' id="validateBtnw3" >REGISTRA</button><br>&nbsp;<br>
						</div>
						<div class="col-md-3">
		 ...
		 <div class="modal fade" id="idModalActualiza" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-header" style="padding: 35px 50px">
					...
					<h4><span class="glyphicon glyphicon-ok-sign"></span> Actualiza Categoria</h4>
				</div>
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="defaultForm" accept-charset="UTF-8"  action="actualizaCategoria" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps" href="#stepOne">Datos de la Categoria</a></h4>
		                            </div>
		                                ...
		                                <div class="panel-body">
		                                    <div class="form-group">
		                                     ...
		                                     <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_nombre" name="nombre" placeholder="Ingrese el Nuevo Nombre" type="text" maxlength="70"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		...
		<div class="modal fade" id="idModalRegistraCate" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="defaultForm" accept-charset="UTF-8" action="registraCategoria" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
