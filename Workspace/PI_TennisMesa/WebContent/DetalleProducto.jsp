...
ResultSet rs;
ps=con.prepareStatement("SELECT nombre, descripcion, precio FROM producto where idProducto =" +request.getParameter("id"));
rs = ps.executeQuery();
...
%>
	...
	<!-- //header -->
       ...
       <div class="producto-prin">
        	<div class="enc-noticia"> PRODUCTO </div>
        	<div class='row' style="margin-top:20px; margin-bottom: 100px">
				...
				%>        
	            	...
	            	<div class='col-sm-6'>
					    	<img src="images/null.jpg" alt="imagen-not-prin" style="width: 100%;">
					   </div>
					   
	            	<div class='col-sm-6'>
			         		<hi id="tit-noticia"><%= rs.getString("nombre")%></hi>
			            	<p class="text-noticia" style="height: 150px">
			                	<%= rs.getString("descripcion")%>
			           	 	</p>
			           	 	<p class="text-noticia" style="height: 50px;">PRECIO: S/.
			                	<%= rs.getDouble("precio")%>
			           	 	</p>
		         		<section class="BNuevo" style="text-align: right;">
        					<a href="crudNoticia.jsp">Agregar al Carro</a>
        				</section>
				</div>
