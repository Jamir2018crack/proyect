...
ResultSet rs;
ps=con.prepareStatement("SELECT titulo, contenido FROM noticia where idNoticia =" +request.getParameter("id"));
rs = ps.executeQuery();
...
%>
	...
	<!-- //header -->
       ...
       <div class="producto-prin">
        	<div class="enc-noticia"> Noticia </div>
