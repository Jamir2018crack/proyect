...
<body>
	...
	<div class="container">
		...
		<div class="col-md-23">
			...
			<form accept-charset="UTF-8" action="consultaCategoria"
				class="simple_form" id="defaultForm2" method="post">
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							<label class="control-label" for="id_nombre_filtro">Nombre</label>
							<input class="form-control" id="id_nombre_filtro" name="filtro"
								placeholder="Ingrese el nombre" type="text" maxlength="70" />
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-3">
						<button type="button" data-toggle='modal'
							onclick="registrarCategoria();" class='btn btn-success'
							id="validateBtnw3">REGISTRA</button>
						<br>&nbsp;<br>
					</div>
					<div class="col-md-3">
						<button type="button" class="btn btn-primary"
							onclick="window.location.href='/PI_TennisMesa/Mantenimiento.jsp'">VOLVER</button>
						<br>&nbsp;<br>
					</div>
				</div>
				<div class="row">
								...
								<tbody>
									<c:forEach items="${categorias}" var="x">
										<tr>
											...
											<td>
												<button type='button' data-toggle='modal'
													onclick="editar('${x.idCategoria}','${x.nombre}');"
											...
											<td>
												<button type='button' data-toggle='modal'
													onclick="eliminar('${x.idCategoria}');">
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="padding: 20px 10px;">
						<form id="defaultForm" accept-charset="UTF-8"
							action="registraCategoria" class="form-horizontal" method="post">
									...
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#steps"
												href="#stepOne">Datos de la Nueva Categoria</a>
										</h4>
									</div>
		...
		<div class="modal fade" id="idModalActualiza">
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="padding: 20px 10px;">
						<form id="defaultForm" accept-charset="UTF-8"
							action="actualizaCategoria" class="form-horizontal" method="post">
							<div class="panel-group" id="steps">
								<!-- Step 1 -->
								<div class="panel panel-default">
									<div class="panel-heading">
