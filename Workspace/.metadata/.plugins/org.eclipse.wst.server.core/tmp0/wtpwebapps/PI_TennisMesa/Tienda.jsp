...
%>
	...
	<!-- //header -->
       ...
       <div class="producto-prin">
        	<div class="enc-noticia">NUESTROS PRODUCTOS</div>
        	
			
			<div style="margin-bottom: 20px">
				<b style="text-align: left;">Categoria</b>
	            ...
	            <div class="col-sm-4">
	         		<div class='panel panel-default'>
		         		...
		         		<div class='pane-body' style="height: 200px">	
			         		<hi id="tit-noticia">
			         			<a href='DetalleProducto.jsp?id=<%= rs.getString("idProducto")%>'>
			         		<%= rs.getString("nombre")%></a></hi>
			            	<p class="text-noticia" style="height: 125px">
			                	<%= rs.getString("descripcion")%>
			           	 	</p>
			           	 	<p class="text-noticia" style="margin-right:20px; text-align: right;"> PRECIO: S/.
			                	<%= rs.getDouble("precio")%>
			           	 	</p>
		         		</div>
					</div>
